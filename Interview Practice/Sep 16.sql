...
having sum(o.amount) > avg(o.amount)
  ...
  with totals as (
    select c.customerid, c.name, sum(o.amount) as total_spent
    from customers c
    join orders o on c.customerid = o.customerid
    group by c.customerid, c.name
),
overall as (
    select avg(total_spent) as avg_spent from totals
)
select t.customerid, t.name, t.total_spent
from totals t, overall o
where t.total_spent > o.avg_spent;
